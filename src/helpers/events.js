...
export default [
  ...
  },
  {
    ...
    start: new Date(2023, 6, 13, 8, 0, 0),
    end: new Date(2023, 6, 13, 10, 30, 0),
  },
  {
    id: 11.1,
    title: 'Inconvenient Conference Call',
    start: new Date(2023, 6, 13, 9, 30, 0),
    end: new Date(2023, 6, 13, 12, 0, 0),
  },
  {
    id: 11.2,
    title: "Project Kickoff - Lou's Shoes",
    start: new Date(2023, 6, 13, 11, 30, 0),
    end: new Date(2023, 6, 13, 14, 0, 0),
  },
  {
    id: 11.3,
    title: 'Quote Follow-up - Tea by Tina',
    start: new Date(2023, 6, 13, 15, 30, 0),
    end: new Date(2023, 6, 13, 16, 0, 0),
  },
  {
    id: 12,
  ...
  },
  {
    ...
    start: new Date(2023, 6, 17, 19, 30, 0),
    end: new Date(2023, 6, 17, 23, 30, 0),
  },
  {
    id: 13,
  ...
  },
  {
    ...
    start: new Date(2023, 6, 14, 16, 30, 0),
    end: new Date(2023, 6, 14, 20, 0, 0),
  },
  {
    id: 18,
    title: 'Itaewon Halloween Meeting',
    start: new Date(2023, 6, 14, 16, 30, 0),
    end: new Date(2023, 6, 14, 17, 30, 0),
  },
  {
    id: 19,
    title: 'Online Coding Test',
    start: new Date(2023, 6, 14, 17, 30, 0),
    end: new Date(2023, 6, 14, 20, 30, 0),
  },
  {
    id: 20,
    title: 'An overlapped Event',
    start: new Date(2023, 6, 14, 17, 0, 0),
    end: new Date(2023, 6, 14, 18, 30, 0),
  },
  {
    id: 21,
  ...
  },
  {
    id: 23,
    title: 'Go to the gym',
    start: new Date(2023, 6, 14, 18, 30, 0),
    end: new Date(2023, 6, 14, 20, 0, 0),
  },
  {
    id: 24,
